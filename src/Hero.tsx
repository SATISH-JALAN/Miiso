          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
            ...
            <div className="lg:col-span-4 flex flex-col items-start lg:mb-8">
              <motion.p
                ...
                className="text-[#DEDBC8] opacity-70 text-xs sm:text-sm md:text-base leading-[1.2] mb-6 max-w-sm"
              >
              ...
              <Link to="/setup">
                <motion.button
                  ...
                  className="group flex items-center gap-2 bg-[#DEDBC8] text-black rounded-full pl-6 pr-2 py-2 hover:gap-3 transition-all duration-300"
                >
