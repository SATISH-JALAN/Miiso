  ...
  return (
    <section id="how-it-works" className="bg-black py-24 px-4 sm:px-6 relative z-10">
      <div className="max-w-7xl mx-auto">
        <span className="text-[#DEDBC8] text-[10px] sm:text-xs tracking-widest uppercase mb-8 block">
          HOW IT WORKS
        </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          <FadeIn delay={0} className="bg-[#101010] p-8 md:p-10 rounded-2xl border border-white/5">
            ...
            <p className="text-[#DEDBC8] text-sm md:text-base leading-relaxed opacity-80">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24">
        <div className="lg:w-1/2">
          ...
          <FadeIn delay={0.2} className="mt-8">
            <p className="text-[#DEDBC8] opacity-70 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl">
        ...
        <div className="lg:w-1/2 flex flex-col gap-4">
          <FadeIn delay={0.3} className="bg-[#101010] p-8 rounded-2xl border border-white/5 flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="text-[#DEDBC8] opacity-70 text-sm">Lost to DeFi exploits in 2024</div>
          </FadeIn>
          <FadeIn delay={0.4} className="bg-[#101010] p-8 rounded-2xl border border-white/5 flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="text-[#DEDBC8] opacity-70 text-sm">Of retail losses from forgotten approvals</div>
          </FadeIn>
          <FadeIn delay={0.5} className="bg-[#101010] p-8 rounded-2xl border border-white/5 flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="text-[#DEDBC8] opacity-70 text-sm">Average time from malicious deploy to first drain</div>
          </FadeIn>
        </div>
      </div>
    </section>
    ...
    <section className="bg-black py-24 px-4 sm:px-6 relative z-10">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        <div className="lg:w-1/2 w-full">
          ...
          />
          <FadeIn delay={0.2} className="mt-8">
            <p className="text-[#DEDBC8] opacity-70 text-sm sm:text-base md:text-lg leading-relaxed max-w-xl mb-6">
  ...
  return (
    <section id="pricing" className="bg-black py-24 px-4 sm:px-6 relative z-10 overflow-x-auto">
      <div className="max-w-5xl mx-auto">
        <span className="text-[#DEDBC8] text-[10px] sm:text-xs tracking-widest uppercase mb-8 block text-center">
          VS THE ALTERNATIVES
        </span>
        <WordsPullUpMultiStyle 
        ...
        <FadeIn delay={0.2} className="w-full overflow-x-auto pb-4">
          <table className="w-full text-left border-collapse min-w-[700px]">
            ...
            <tbody className="text-sm md:text-base text-[#DEDBC8]">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center text-center mb-32 bg-[#101010] p-12 md:p-24 rounded-3xl border border-white/5">
          ...
          <FadeIn delay={0.2} className="max-w-xl mx-auto flex flex-col items-center">
            <p className="text-[#DEDBC8] opacity-70 text-sm sm:text-base leading-relaxed mb-8">
              Set up Miiso in under two minutes. No ETH needed. Cancel any time.
            </p>
            <Link to="/setup" className="block w-fit">
              <button className="group flex items-center gap-2 bg-[#DEDBC8] text-black rounded-full pl-6 pr-2 py-2 hover:gap-3 transition-all duration-300">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 border-t border-white/10 pt-8 mt-12">
          <div>
            ...
            <p className="text-xs text-[#DEDBC8] opacity-50 font-mono">Fermented protection for your digital assets.</p>
          </div>
